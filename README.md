...
<body>
    ...
    <footer>
        <p>&copy; 2024 Designed and Developed by DHANASHREE ARUN</p>
            </footer>
</body>
</html>
gallery.html
...
<body>
    ...
    <main>
        ...
        <div class="gallery">
                <div class="photo">
                <img src="bangtan.jpeg" alt="bangtan">
                <p>bangtan</p>
                </div>
                <div class="photo">
                <img src="doggie.jpeg" alt="doggie">
                <p>doggie</p>
                </div>
                <div class="photo">
                <img src="doremon.jpeg" alt="doremon">
                <p>doremon</p>
                </div>
                <div class="photo">
    ...
    <footer>
       <p> &copy; 2024 Designed and Developed by DhanashreeArun<\p>
</footer>
</body>
</html>
contact.html
...
<body>
    ...
    <main>
        ...
        <h2>Get in Touch</h2>
        <p><strong>Website Handeled By:</strong> DHANASHREE ARUN </p>
        <p><strong>Phone:</strong> 7086697138</p>
...
## OUTPUT:
![alt text](vijay/myapp/static/1.1.png)
![alt text](vijay/myapp/static/1.2.png)
![alt text](vijay/myapp/static/1.3.png)
![alt text](vijay/myapp/static/1.4.png)
